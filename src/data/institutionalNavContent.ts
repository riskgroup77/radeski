...
export const INSTITUTIONAL_NAV_SECTIONS: InstitutionalNavSection[] = [
  ...
  },
  {
    ...
    label: L('Teletibbiyot', 'Телемедицина', 'Telemedicine'),
    navShort: L('Teletibbiyot', 'Телемедицина', 'Telemedicine'),
    dropdownTitle: L('Teletibbiyot', 'Телемедицина', 'Telemedicine'),
    dropdownHint: L(
      'Masofaviy tibbiy maslahat va raqamli kuzatuv',
      'Дистанционная медицинская консультация и цифровое сопровождение',
      'Remote medical consultations and digital follow-up care',
    ),
    topics: [],
  },
  {
