...
export const DICTIONARY = {
  uz: {
    ...
    articlesTitle: "Dermatologiya maqolalari — Farg'ona | Qo'qon",
    ...
    seoTitle: "Dermatologiya Farg'ona | Qo'qon | Radeski Skin Clinic — kosmetologiya, IPL, lazer",
    seoText: "Radeski — Farg'ona va Qo'qondagi dermatologiya va kosmetologiya klinikasi. IPL, lazer epilyatsiya, dermatoskopiya, fototerapiya, botoks va Mohs mikrografik jarrohligi bilan xizmat ko'rsatamiz.",
    aboutHeader: "Dermatologiya Farg'ona | Qo'qon — Radeski Skin Clinic",
  ...
  ru: {
    ...
    articlesTitle: "Статьи по дерматологии — Фергана | Коканд",
    ...
    seoTitle: "Дерматология Фергана | Коканд | Radeski Skin Clinic — косметология, IPL, лазер",
    seoText: "Radeski — клиника дерматологии и косметологии в Фергане и Коканде. IPL, лазерная эпиляция, дерматоскопия, фототерапия, ботокс и хирургия Mohs.",
    aboutHeader: "Дерматология Фергана | Коканд — Radeski Skin Clinic",
  ...
  en: {
    ...
    articlesTitle: "Dermatology articles — Fergana | Kokand",
    ...
    seoTitle: "Dermatology Fergana | Kokand | Radeski Skin Clinic — cosmetology, IPL, laser",
    seoText: "Radeski Skin Clinic in Fergana and Kokand: dermatology, IPL, laser hair removal, dermatoscopy, phototherapy, Botox and Mohs surgery.",
    aboutHeader: "Dermatology Fergana | Kokand — Radeski Skin Clinic",
