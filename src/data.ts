...
export const DICTIONARY = {
  uz: {
    ...
    branchesDesc: "Radeski filiallari — Farg'ona, Qo'qon va Belgiya (Liège)dagi manzil, telefon va ish vaqti",
  ...
  ru: {
    ...
    branchesDesc: 'Филиалы Radeski — Фергана, Коканд и Бельгия (Льеж): адреса, телефон и график',
  ...
  en: {
    ...
    branchesDesc: 'Radeski branches — Fergana, Kokand, and Belgium (Liège): address, phone, and hours',
