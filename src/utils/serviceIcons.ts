...
export const SUB_SERVICE_ICON_BY_ID: Record<string, string> = {
  ...
  'ipl-inmode': 'SunMedium',
  'hollywood-spectra': 'Sparkles',
  mikrotoki: 'Waves',
  ...
  'trix-konsult': 'ScanSearch',
  'trix-alopecia': 'ScanSearch',
  'trix-monitoring': 'ScanEye',
  biopsiya: 'Microscope',
...
const SUB_SERVICE_KEYWORD_RULES: { keywords: string[]; icon: string }[] = [
  ...
  { keywords: ['skanerlash', 'сканер', 'body mapping', 'xaritalash'], icon: 'ScanEye' },
