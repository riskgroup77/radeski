/**
 * clinic-video-47 ni API ga yuklaydi (dalillarga asoslangan tibbiyot).
 * Usage: npx tsx scripts/seedVideo47ToApi.ts
 */
...
const TARGET = CLINIC_VIDEOS.filter((v) => v.id === 'clinic-video-47');
