/**
 * clinic-video-45 ni API ga yuklaydi (bemorlar — yordam bergan odamlar).
 * Usage: npx tsx scripts/seedVideo45ToApi.ts
 */
...
const TARGET = CLINIC_VIDEOS.filter((v) => v.id === 'clinic-video-45');
