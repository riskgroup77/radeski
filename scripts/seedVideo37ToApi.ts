/**
 * clinic-video-37 ni API ga yuklaydi.
 * Usage: npx tsx scripts/seedVideo37ToApi.ts
 */
...
const TARGET = CLINIC_VIDEOS.filter((v) => v.id === 'clinic-video-37');
...
async function main() {
  ...
  if (TARGET.length !== 1) throw new Error('clinic-video-37 missing');
