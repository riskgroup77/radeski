/**
 * clinic-video-48 ni API ga yuklaydi (kosmetolog tavsiyasi — qora nuqtalar).
 * Usage: npx tsx scripts/seedVideo48ToApi.ts
 */
...
const TARGET = CLINIC_VIDEOS.filter((v) => v.id === 'clinic-video-48');
