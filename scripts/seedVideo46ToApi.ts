/**
 * clinic-video-46 ni API ga yuklaydi (IPL — terini ichkaridan tiklash).
 * Usage: npx tsx scripts/seedVideo46ToApi.ts
 */
...
const TARGET = CLINIC_VIDEOS.filter((v) => v.id === 'clinic-video-46');
