/**
 * clinic-video-40 ni API ga yuklaydi.
 * Usage: npx tsx scripts/seedVideo40ToApi.ts
 */
...
const TARGET = CLINIC_VIDEOS.filter((v) => v.id === 'clinic-video-40');
...
async function main() {
  ...
  if (TARGET.length !== 1) throw new Error('clinic-video-40 missing');
