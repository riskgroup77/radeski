/**
 * clinic-video-38 ni API ga yuklaydi.
 * Usage: npx tsx scripts/seedVideo38ToApi.ts
 */
...
const TARGET = CLINIC_VIDEOS.filter((v) => v.id === 'clinic-video-38');
...
async function main() {
  ...
  if (TARGET.length !== 1) throw new Error('clinic-video-38 missing');
