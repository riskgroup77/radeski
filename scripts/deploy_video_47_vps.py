#!/usr/bin/env python3
"""Upload public/videos/47.mp4 to VPS public + dist folders."""
import os
import sys
...
def main() -> None:
    ...
    _, stdout, _ = client.exec_command(
        ...
        "req=urllib.request.Request('https://127.0.0.1/videos/47.mp4', method='HEAD', headers={'Host':'radeski.uz'})\n"
        "with urllib.request.urlopen(req, context=ctx, timeout=30) as r:\n"
        " print('static47', r.status, r.headers.get('Content-Type'), r.headers.get('Content-Length'))\n"
        "PY"
    )
